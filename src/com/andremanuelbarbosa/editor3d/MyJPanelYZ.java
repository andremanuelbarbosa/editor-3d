...
public class MyJPanelYZ extends JPanel implements MyJPanel
{
    ...
    public MyJPanelYZ(Editor3D editor3D,JInternalFrame jInternalFrame)
    {
    ...
    private void myMouseEntered(MouseEvent evt)
    {
        ...
        editor3D.setMousePosition(Editor3D.YZ);
    ...
    private void myMouseMoved(MouseEvent evt)
    {
        ...
        editor3D.setMousePosition(-(evt.getY() - center.y),-(evt.getX() - center.x));
    ...
    public void updateImage()
    {
        ...
        if(img != null)
        {
            ...
            if(axisEnabled)
            {
                ...
                g2D.drawString("z",center.x - i - 6,center.y + 14);
            ...
            for(ListIterator listItr = solids.listIterator() ; listItr.hasNext() ; )
                ((Solid) listItr.next()).paintYZ(g,this);
