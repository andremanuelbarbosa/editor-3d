...
public class MyJPanelXZ extends JPanel implements MyJPanel
{
    ...
    public MyJPanelXZ(Editor3D editor3D,JInternalFrame jInternalFrame)
    {
    ...
    private void myMouseEntered(MouseEvent evt)
    {
        ...
        editor3D.setMousePosition(Editor3D.XZ);
